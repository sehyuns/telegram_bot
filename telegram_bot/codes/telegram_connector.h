...
protected:
	...
	static SIZE_T	http_init_data(TCHAR* contents_in, SIZE_T size_in, SIZE_T nmemb_in, VOID* user_data_in);
	static SIZE_T	http_receive_data(TCHAR* contents_in, SIZE_T size_in, SIZE_T nmemb_in, VOID* user_data_in);
